# ✅ Streamlit Lab Report OCR App (Final Version) with Clean Alignment & Comments
import os
import cv2
import numpy as np
import pandas as pd
...
# ✅ Mapping YOLO class IDs to field names
class_map = {
    0: "Test Name",
    1: "Value",
    2: "Units",
...
# 🧠 OCR Engine Selector (fully centered)
...
with st.expander("📘 How it works"):
    ...
    3. EasyOCR or Pytesseract extracts the text.
    4. Smart merging of split test names.
    5. View table, download CSV, and check image overlay.
    """)

# 📤 Upload Instruction (Centered and Friendly)
